...
Namespace WpfApplication.ViewModels
	Public Class MainViewModel
		...
		Public Sub New()
			DocumentViews = New ObservableCollection(Of PanelViewModel)() From {
				New DocumentViewModel() With {
					.Caption = "Document1",
					.Content = "A document panel",
					.Glyph="/Images/change.png"
				},
				New DocumentViewModel() With {
					.Caption = "Document2",
					.Content = "A document panel",
					.Glyph="/Images/create.png"
				},
				New DocumentViewModel() With {
					.Caption = "Document3",
					.Content = "A document panel",
					.Glyph="/Images/new-16x16.png"
				},
				New DocumentViewModel() With {
					.Caption = "Document4",
					.Content = "A document panel"
			...
			LayoutViews = New ObservableCollection(Of PanelViewModel)() From {
